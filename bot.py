...
async def owner_users(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                [
                    InlineKeyboardButton("⬅️ Prev", callback_data="users_prev"),
                    InlineKeyboardButton("🔄 Refresh", callback_data="owner_users"),
                    InlineKeyboardButton("➡️ Next", callback_data="users_next")
                ],
                [
